    ...
    <>
      ...
      <div className="container my-3 py-3">
        ...
        <p className="lead text-center">
          Welcome to <strong>TalibiMart</strong>, your trusted destination for stylish fashion, premium electronics, and elegant jewelry.
          This eCommerce platform was developed as part of a final year Computer Science thesis project by Talibi Abderrahim,
          showcasing a blend of technical innovation and user-focused design.
          <br /><br />
          Our mission is to provide a seamless and enjoyable shopping experience where users can browse curated collections of men’s and women’s clothing,
          accessories, and cutting-edge tech—all in one place. TalibiMart represents the fusion of modern web technologies, convenience, and visual elegance.
        </p>
